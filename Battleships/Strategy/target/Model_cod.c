...
static tSDLSignalParaInfo fSDL_DestroyShip[] = {
  {(tSDLTypeInfo *)&ySDL_z_BasicTypes_1J_tShipId, xOffsetOf(yPDef_DestroyShip,
    Param1)},
  {(tSDLTypeInfo *)&ySDL_z_BasicTypes_1K_tStrategyId,
...
tSDLSignalInfo ySDL_resetStrategy = {type_SDL_Signal, 0,
  (xptrint)sizeof(XSIGNALHEADERTYPE) T_SDL_OPFUNCS(0) T_SDL_EXTRA_VALUE
  T_Signal_SDL_Names("resetStrategy"), 0, 0};
...
tSDLSignalInfo * xSignalList[] = {&ySDL_FinishSimulation,
  ...
  &ySDL_StrategyLose, &ySDL_resetStrategy, &ySDL_messageLog,
  &ySDL_messageError, 0};
xSignalIdNode xSignalIdList[] = {&ySigR_z_BasicTypes_04_FinishSimulation,
  &ySigR_z_BasicTypes_05_OrderSpeedRequest,
  &ySigR_z_BasicTypes_06_OrderTurnRequest,
  &ySigR_z_BasicTypes_07_OrderFireRequest,
  &ySigR_z_BasicTypes_02_InitDataComplete,
  &ySigR_z_BasicTypes_03_StartSimulation, &ySigR_z_BasicTypes_08_DestroyShip,
  &ySigR_z_BasicTypes_0B_OrderSpeedResponse,
  &ySigR_z_BasicTypes_0C_OrderSpeedReject,
  &ySigR_z_BasicTypes_0D_OrderTurnResponse,
  &ySigR_z_BasicTypes_0E_OrderTurnReject,
  &ySigR_z_BasicTypes_0F_OrderFireResponse,
  &ySigR_z_BasicTypes_0G_OrderFireReject,
  &ySigR_z_BasicTypes_0H_ShipsCurrentState, &ySigR_z_BasicTypes_0I_VisibleShip,
  &ySigR_z_BasicTypes_09_StrategyVictory, &ySigR_z_BasicTypes_0A_StrategyLose,
  &ySigR_z_BasicTypes_0L_resetStrategy, &ySigR_z_BasicTypes_0J_messageLog,
  &ySigR_z_BasicTypes_0K_messageError, 0};
